...
public class PDFActivityReading7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (postion==0)
        {
            pdfView.fromAsset("malumotnoma/Ma'lumotnoma Soxibov.PDF").load();
            chaptername.setText(chapter);
        }
        if (postion==1)
        {
            pdfView.fromAsset("malumotnoma/obektivka Salimova.pdf").load();
            chaptername.setText(chapter);
        }
