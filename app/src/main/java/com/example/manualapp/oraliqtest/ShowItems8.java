package com.example.manualapp.oraliqtest;
...
public class ShowItems8 extends AppCompatActivity {
    ArrayList<SubjectModel> list;
    SubjectAdapter8 adapter;
...
// Set the title to an empty string or any desired title
        ...
        list.add(new SubjectModel("Oraliq test savollar"));


        adapter = new SubjectAdapter8(this, list);

        recyclerView.setAdapter(adapter);

        // Set the manual name to the TextView in the Toolbar
        TextView textView = findViewById(R.id.imageForList);
        textView.setText("Oraliq savollar");
        CollapsingToolbarLayout collapsingToolbarLayout = findViewById(R.id.collapsingToolbarLayout);
        collapsingToolbarLayout.setTitle("Oraliq savollar");
    }
    @Override
