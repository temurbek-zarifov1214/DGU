...
public class SubjectAdapter6 extends RecyclerView.Adapter<SubjectAdapter6.viewHolder> {

    Context context;
    ArrayList<SubjectModel> list;


    public SubjectAdapter6(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PDFActivityReading6.class);
