...
public class SubjectAdapter4 extends RecyclerView.Adapter<SubjectAdapter4.viewHolder> {

    Context context;
    ArrayList<SubjectModel> list;


    public SubjectAdapter4(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PDFActivityReading4.class);
