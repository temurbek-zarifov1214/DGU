package com.example.manualapp.yakuniytest;
...
public class ShowItems9 extends AppCompatActivity {
    ArrayList<SubjectModel> list;
    SubjectAdapter9 adapter;
...
// Set the title to an empty string or any desired title
        ...
        list.add(new SubjectModel("Test savollar"));


        adapter = new SubjectAdapter9(this, list);

        recyclerView.setAdapter(adapter);

        // Set the manual name to the TextView in the Toolbar
        TextView textView = findViewById(R.id.imageForList);
        textView.setText("Test savollar");
        CollapsingToolbarLayout collapsingToolbarLayout = findViewById(R.id.collapsingToolbarLayout);
        collapsingToolbarLayout.setTitle("Test savollar");
    }
    @Override
