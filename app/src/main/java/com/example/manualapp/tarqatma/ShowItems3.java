package com.example.manualapp.tarqatma;
...
// Set the title to an empty string or any desired title
        ...
        list.add(new SubjectModel("GERMANIYADA MAKTAB VA TA'LIM TIZIMI"));
        ...
        textView.setText("Tarqatma materiallar");
        CollapsingToolbarLayout collapsingToolbarLayout = findViewById(R.id.collapsingToolbarLayout);
        collapsingToolbarLayout.setTitle("Tarqatma materiallar");
    }
    @Override
