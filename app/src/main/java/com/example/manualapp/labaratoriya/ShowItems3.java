...
public class ShowItems3 extends AppCompatActivity {
    ArrayList<SubjectModel> list;
    SubjectAdapter3 adapter;
...
// Set the title to an empty string or any desired title
        ...
        list.add(new SubjectModel("1-laboratoriya"));
        list.add(new SubjectModel("2-laboratoriya"));
        list.add(new SubjectModel("3-laboratoriya"));
        list.add(new SubjectModel("4-laboratoriya"));
        list.add(new SubjectModel("5-laboratoriya"));


        adapter = new SubjectAdapter3(this, list);

        recyclerView.setAdapter(adapter);

        // Set the manual name to the TextView in the Toolbar
        TextView textView = findViewById(R.id.imageForList);
        textView.setText("Laboratoriya mashg'uloti");
        CollapsingToolbarLayout collapsingToolbarLayout = findViewById(R.id.collapsingToolbarLayout);
        collapsingToolbarLayout.setTitle("Laboratoriya mashg'uloti");
    }
    @Override
