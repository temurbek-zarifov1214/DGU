...
import com.example.manualapp.maruza.PDFActivityReading2;

import java.util.ArrayList;

public class SubjectAdapter5 extends RecyclerView.Adapter<SubjectAdapter5.viewHolder> {

    Context context;
    ArrayList<SubjectModel> list;


    public SubjectAdapter5(Context context, ArrayList<SubjectModel> list) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PDFActivityReading5.class);
